# Comparing `tmp/pympipool-0.4.3.tar.gz` & `tmp/pympipool-0.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pympipool-0.4.3.tar", last modified: Mon Jun 26 14:18:08 2023, max compression
+gzip compressed data, was "pympipool-0.5.0.tar", last modified: Sun Jun 11 14:13:06 2023, max compression
```

## Comparing `pympipool-0.4.3.tar` & `pympipool-0.5.0.tar`

### file list

```diff
@@ -1,41 +1,41 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.781021 pympipool-0.4.3/
--rw-r--r--   0 runner    (1001) docker     (123)     1511 2023-06-26 14:18:05.000000 pympipool-0.4.3/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-06-26 14:18:05.000000 pympipool-0.4.3/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)    10286 2023-06-26 14:18:08.781021 pympipool-0.4.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     9589 2023-06-26 14:18:05.000000 pympipool-0.4.3/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.781021 pympipool-0.4.3/pympipool/
--rw-r--r--   0 runner    (1001) docker     (123)      264 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      496 2023-06-26 14:18:08.781021 pympipool-0.4.3/pympipool/_version.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.777021 pympipool-0.4.3/pympipool/executor/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/executor/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2418 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/executor/mpiexec.py
--rw-r--r--   0 runner    (1001) docker     (123)     1544 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/executor/mpipool.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.781021 pympipool-0.4.3/pympipool/share/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1926 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/communication.py
--rw-r--r--   0 runner    (1001) docker     (123)     4586 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/executor.py
--rw-r--r--   0 runner    (1001) docker     (123)     5582 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/parallel.py
--rw-r--r--   0 runner    (1001) docker     (123)     7254 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/pool.py
--rw-r--r--   0 runner    (1001) docker     (123)     6438 2023-06-26 14:18:05.000000 pympipool-0.4.3/pympipool/share/serial.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.777021 pympipool-0.4.3/pympipool.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)    10286 2023-06-26 14:18:08.000000 pympipool-0.4.3/pympipool.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      798 2023-06-26 14:18:08.000000 pympipool-0.4.3/pympipool.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-26 14:18:08.000000 pympipool-0.4.3/pympipool.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       60 2023-06-26 14:18:08.000000 pympipool-0.4.3/pympipool.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-26 14:18:08.000000 pympipool-0.4.3/pympipool.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      177 2023-06-26 14:18:08.781021 pympipool-0.4.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1158 2023-06-26 14:18:08.000000 pympipool-0.4.3/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 14:18:08.781021 pympipool-0.4.3/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     2401 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_communicator_split.py
--rw-r--r--   0 runner    (1001) docker     (123)     5368 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_executor.py
--rw-r--r--   0 runner    (1001) docker     (123)      886 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_future.py
--rw-r--r--   0 runner    (1001) docker     (123)      920 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_interface.py
--rw-r--r--   0 runner    (1001) docker     (123)     2699 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_multitask.py
--rw-r--r--   0 runner    (1001) docker     (123)     2073 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_parse.py
--rw-r--r--   0 runner    (1001) docker     (123)     2292 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_pool.py
--rw-r--r--   0 runner    (1001) docker     (123)      687 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_queue.py
--rw-r--r--   0 runner    (1001) docker     (123)     1067 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_task.py
--rw-r--r--   0 runner    (1001) docker     (123)     4094 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_worker.py
--rw-r--r--   0 runner    (1001) docker     (123)     1381 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_worker_memory.py
--rw-r--r--   0 runner    (1001) docker     (123)      709 2023-06-26 14:18:05.000000 pympipool-0.4.3/tests/test_zmq.py
--rw-r--r--   0 runner    (1001) docker     (123)    68611 2023-06-26 14:18:05.000000 pympipool-0.4.3/versioneer.py
...
### Comparing `pympipool-0.4.3/LICENSE` & `pympipool-0.5.0/LICENSE`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/PKG-INFO` & `pympipool-0.5.0/PKG-INFO`
...
### Comparing `pympipool-0.4.3/README.md` & `pympipool-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/pympipool/executor/mpiexec.py` & `pympipool-0.5.0/pympipool/executor/mpiexec.py`
...
### Comparing `pympipool-0.4.3/pympipool/executor/mpipool.py` & `pympipool-0.5.0/pympipool/executor/mpipool.py`
...
### Comparing `pympipool-0.4.3/pympipool/share/communication.py` & `pympipool-0.5.0/pympipool/share/communication.py`
...
### Comparing `pympipool-0.4.3/pympipool/share/executor.py` & `pympipool-0.5.0/pympipool/share/executor.py`
...
### Comparing `pympipool-0.4.3/pympipool/share/parallel.py` & `pympipool-0.5.0/pympipool/share/parallel.py`
...
### Comparing `pympipool-0.4.3/pympipool/share/pool.py` & `pympipool-0.5.0/pympipool/share/pool.py`
...
### Comparing `pympipool-0.4.3/pympipool/share/serial.py` & `pympipool-0.5.0/pympipool/share/serial.py`
...
### Comparing `pympipool-0.4.3/pympipool.egg-info/PKG-INFO` & `pympipool-0.5.0/pympipool.egg-info/PKG-INFO`
...
### Comparing `pympipool-0.4.3/pympipool.egg-info/SOURCES.txt` & `pympipool-0.5.0/pympipool.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/setup.py` & `pympipool-0.5.0/setup.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_communicator_split.py` & `pympipool-0.5.0/tests/test_communicator_split.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_executor.py` & `pympipool-0.5.0/tests/test_executor.py`
...
### Comparing `pympipool-0.4.3/tests/test_future.py` & `pympipool-0.5.0/tests/test_future.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_interface.py` & `pympipool-0.5.0/tests/test_interface.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_multitask.py` & `pympipool-0.5.0/tests/test_multitask.py`
...
### Comparing `pympipool-0.4.3/tests/test_parse.py` & `pympipool-0.5.0/tests/test_parse.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_pool.py` & `pympipool-0.5.0/tests/test_pool.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_queue.py` & `pympipool-0.5.0/tests/test_queue.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_task.py` & `pympipool-0.5.0/tests/test_task.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/tests/test_worker.py` & `pympipool-0.5.0/tests/test_worker.py`
...
### Comparing `pympipool-0.4.3/tests/test_worker_memory.py` & `pympipool-0.5.0/tests/test_worker_memory.py`
...
### Comparing `pympipool-0.4.3/tests/test_zmq.py` & `pympipool-0.5.0/tests/test_zmq.py`

 * *Files identical despite different names*

### Comparing `pympipool-0.4.3/versioneer.py` & `pympipool-0.5.0/versioneer.py`
