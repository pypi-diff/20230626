# Comparing `tmp/napalm_nokia_olt-0.0.7.tar.gz` & `tmp/napalm_nokia_olt-0.0.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/Users/nahanga/Desktop/NOKIA/napalm_nokia_olt/dist/.tmp-qkxg5rw3/napalm_nokia_olt-0.0.7.tar", last modified: Fri Jun 23 15:37:46 2023, max compression
...
## Comparing `napalm_nokia_olt-0.0.7.tar` & `napalm_nokia_olt-0.0.8.tar`

### file list

```diff
@@ -1,15 +1,15 @@
-drwxr-xr-x   0 nahanga    (501) staff       (20)        0 2023-06-23 15:37:46.787939 napalm_nokia_olt-0.0.7/
--rw-r--r--   0 nahanga    (501) staff       (20)    11324 2022-08-16 08:37:40.000000 napalm_nokia_olt-0.0.7/LICENSE.md
--rw-r--r--   0 nahanga    (501) staff       (20)      687 2023-06-23 15:37:46.788133 napalm_nokia_olt-0.0.7/PKG-INFO
--rw-r--r--   0 nahanga    (501) staff       (20)      167 2023-02-10 17:17:02.000000 napalm_nokia_olt-0.0.7/README.md
-drwxr-xr-x   0 nahanga    (501) staff       (20)        0 2023-06-23 15:37:46.760817 napalm_nokia_olt-0.0.7/napalm_nokia_olt/
--rw-r--r--   0 nahanga    (501) staff       (20)      115 2023-02-10 17:39:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt/__init__.py
--rw-r--r--   0 nahanga    (501) staff       (20)     9902 2023-06-23 15:36:29.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt/nokia_olt.py
-drwxr-xr-x   0 nahanga    (501) staff       (20)        0 2023-06-23 15:37:46.787547 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/
--rw-r--r--   0 nahanga    (501) staff       (20)      687 2023-06-23 15:37:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/PKG-INFO
--rw-r--r--   0 nahanga    (501) staff       (20)      297 2023-06-23 15:37:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/SOURCES.txt
--rw-r--r--   0 nahanga    (501) staff       (20)        1 2023-06-23 15:37:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/dependency_links.txt
--rw-r--r--   0 nahanga    (501) staff       (20)       10 2023-06-23 15:37:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/requires.txt
--rw-r--r--   0 nahanga    (501) staff       (20)       17 2023-06-23 15:37:46.000000 napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/top_level.txt
--rw-r--r--   0 nahanga    (501) staff       (20)       38 2023-06-23 15:37:46.789145 napalm_nokia_olt-0.0.7/setup.cfg
--rw-r--r--   0 nahanga    (501) staff       (20)      927 2023-06-23 15:36:59.000000 napalm_nokia_olt-0.0.7/setup.py
...
### Comparing `napalm_nokia_olt-0.0.7/LICENSE.md` & `napalm_nokia_olt-0.0.8/LICENSE.md`

 * *Files identical despite different names*

### Comparing `napalm_nokia_olt-0.0.7/PKG-INFO` & `napalm_nokia_olt-0.0.8/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: napalm_nokia_olt Version: 0.0.7 Summary: Network
...
### Comparing `napalm_nokia_olt-0.0.7/napalm_nokia_olt.egg-info/PKG-INFO` & `napalm_nokia_olt-0.0.8/napalm_nokia_olt.egg-info/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: napalm-nokia-olt Version: 0.0.7 Summary: Network
...
### Comparing `napalm_nokia_olt-0.0.7/setup.py` & `napalm_nokia_olt-0.0.8/setup.py`
