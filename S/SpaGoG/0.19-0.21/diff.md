# Comparing `tmp/SpaGoG-0.19.tar.gz` & `tmp/SpaGoG-0.21.tar.gz`
...
## Comparing `SpaGoG-0.19.tar` & `SpaGoG-0.21.tar`
...
### Comparing `SpaGoG-0.19/setup.py` & `SpaGoG-0.21/setup.py`
...
### Comparing `SpaGoG-0.19/spagog/main.py` & `SpaGoG-0.21/spagog/main.py`

 * *Files identical despite different names*

### Comparing `SpaGoG-0.19/spagog/experiments.py` & `SpaGoG-0.21/spagog/experiments.py`
