# Comparing `tmp/aolab-bmi3d-0.9.5.tar.gz` & `tmp/aolab-bmi3d-0.9.6.tar.gz`
...
### Comparing `aolab-bmi3d-0.9.5/built_in_tasks/bmimultitasks.py` & `aolab-bmi3d-0.9.6/built_in_tasks/bmimultitasks.py`
...
### Comparing `aolab-bmi3d-0.9.5/db/tracker/admin.py` & `aolab-bmi3d-0.9.6/db/tracker/admin.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/ajax.py` & `aolab-bmi3d-0.9.6/db/tracker/ajax.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/celery.py` & `aolab-bmi3d-0.9.6/db/tracker/celery.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/cloud.py` & `aolab-bmi3d-0.9.6/db/tracker/cloud.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/dbq.py` & `aolab-bmi3d-0.9.6/db/tracker/dbq.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/json_param.py` & `aolab-bmi3d-0.9.6/db/tracker/json_param.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0001_initial.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0002_auto_20191112_2306.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0002_auto_20191112_2306.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0003_auto_20191113_2158.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0003_auto_20191113_2158.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0004_keyvaluestore.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0004_keyvaluestore.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0010_experimenter.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0010_experimenter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/migrations/0011_auto_20211017_1548.py` & `aolab-bmi3d-0.9.6/db/tracker/migrations/0011_auto_20211017_1548.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/models.py` & `aolab-bmi3d-0.9.6/db/tracker/models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/tasktrack.py` & `aolab-bmi3d-0.9.6/db/tracker/tasktrack.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/trainbmi.py` & `aolab-bmi3d-0.9.6/db/tracker/trainbmi.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/views.py` & `aolab-bmi3d-0.9.6/db/tracker/views.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/tracker/websocket.py` & `aolab-bmi3d-0.9.6/db/tracker/websocket.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/db/urls.py` & `aolab-bmi3d-0.9.6/db/urls.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/__init__.py` & `aolab-bmi3d-0.9.6/features/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/arduino_features.py` & `aolab-bmi3d-0.9.6/features/arduino_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/blackrock_features.py` & `aolab-bmi3d-0.9.6/features/blackrock_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/bmi_task_features.py` & `aolab-bmi3d-0.9.6/features/bmi_task_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/ecube_features.py` & `aolab-bmi3d-0.9.6/features/ecube_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/eyetracker_features.py` & `aolab-bmi3d-0.9.6/features/eyetracker_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/generator_features.py` & `aolab-bmi3d-0.9.6/features/generator_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/hdf_features.py` & `aolab-bmi3d-0.9.6/features/hdf_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/kinarm_features.py` & `aolab-bmi3d-0.9.6/features/kinarm_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/laser_features.py` & `aolab-bmi3d-0.9.6/features/laser_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/neural_sys_features.py` & `aolab-bmi3d-0.9.6/features/neural_sys_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/optitrack_features.py` & `aolab-bmi3d-0.9.6/features/optitrack_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/peripheral_device_features.py` & `aolab-bmi3d-0.9.6/features/peripheral_device_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/phasespace_features.py` & `aolab-bmi3d-0.9.6/features/phasespace_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/plexon_features.py` & `aolab-bmi3d-0.9.6/features/plexon_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/reward_features.py` & `aolab-bmi3d-0.9.6/features/reward_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/serial_port_sensor.py` & `aolab-bmi3d-0.9.6/features/serial_port_sensor.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/simulation_features.py` & `aolab-bmi3d-0.9.6/features/simulation_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/sync_features.py` & `aolab-bmi3d-0.9.6/features/sync_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/touch_features.py` & `aolab-bmi3d-0.9.6/features/touch_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/features/video_recording_features.py` & `aolab-bmi3d-0.9.6/features/video_recording_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/arduino_imu.py` & `aolab-bmi3d-0.9.6/riglib/arduino_imu.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/arduino_joystick.py` & `aolab-bmi3d-0.9.6/riglib/arduino_joystick.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/blackrock/__init__.py` & `aolab-bmi3d-0.9.6/riglib/blackrock/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/blackrock/brMiscFxns.py` & `aolab-bmi3d-0.9.6/riglib/blackrock/brMiscFxns.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/blackrock/brpylib.py` & `aolab-bmi3d-0.9.6/riglib/blackrock/brpylib.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/blackrock/cerelink.py` & `aolab-bmi3d-0.9.6/riglib/blackrock/cerelink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/accumulator.py` & `aolab-bmi3d-0.9.6/riglib/bmi/accumulator.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/assist.py` & `aolab-bmi3d-0.9.6/riglib/bmi/assist.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/bmi.py` & `aolab-bmi3d-0.9.6/riglib/bmi/bmi.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/clda.py` & `aolab-bmi3d-0.9.6/riglib/bmi/clda.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/extractor.py` & `aolab-bmi3d-0.9.6/riglib/bmi/extractor.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/feedback_controllers.py` & `aolab-bmi3d-0.9.6/riglib/bmi/feedback_controllers.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/goal_calculators.py` & `aolab-bmi3d-0.9.6/riglib/bmi/goal_calculators.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/kfdecoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/kfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/kfdecoder_fcns.py` & `aolab-bmi3d-0.9.6/riglib/bmi/kfdecoder_fcns.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/lindecoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/lindecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/onedim_lfp_decoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/onedim_lfp_decoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/ppfdecoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/ppfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/rat_bmi_decoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/rat_bmi_decoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/robot_arms.py` & `aolab-bmi3d-0.9.6/riglib/bmi/robot_arms.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/sim_neurons.py` & `aolab-bmi3d-0.9.6/riglib/bmi/sim_neurons.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/sskfdecoder.py` & `aolab-bmi3d-0.9.6/riglib/bmi/sskfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/state_space_models.py` & `aolab-bmi3d-0.9.6/riglib/bmi/state_space_models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/bmi/train.py` & `aolab-bmi3d-0.9.6/riglib/bmi/train.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/button.py` & `aolab-bmi3d-0.9.6/riglib/button.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/calibrations.py` & `aolab-bmi3d-0.9.6/riglib/calibrations.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/dio/NIUSB6501/control_comedi_swig.py` & `aolab-bmi3d-0.9.6/riglib/dio/NIUSB6501/control_comedi_swig.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/dio/NIUSB6501/py_comedi_control.py` & `aolab-bmi3d-0.9.6/riglib/dio/NIUSB6501/py_comedi_control.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/dio/nidaq/__init__.py` & `aolab-bmi3d-0.9.6/riglib/dio/nidaq/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/dio/parse.py` & `aolab-bmi3d-0.9.6/riglib/dio/parse.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/e3vision.py` & `aolab-bmi3d-0.9.6/riglib/e3vision.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/ecube/__init__.py` & `aolab-bmi3d-0.9.6/riglib/ecube/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/ecube/file.py` & `aolab-bmi3d-0.9.6/riglib/ecube/file.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/ecube/pyeCubeStream.py` & `aolab-bmi3d-0.9.6/riglib/ecube/pyeCubeStream.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/Pygame.py` & `aolab-bmi3d-0.9.6/riglib/experiment/Pygame.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/__init__.py` & `aolab-bmi3d-0.9.6/riglib/experiment/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/experiment.py` & `aolab-bmi3d-0.9.6/riglib/experiment/experiment.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/generate.py` & `aolab-bmi3d-0.9.6/riglib/experiment/generate.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/mocks.py` & `aolab-bmi3d-0.9.6/riglib/experiment/mocks.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/report.py` & `aolab-bmi3d-0.9.6/riglib/experiment/report.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/experiment/task_wrapper.py` & `aolab-bmi3d-0.9.6/riglib/experiment/task_wrapper.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/eyetracker.py` & `aolab-bmi3d-0.9.6/riglib/eyetracker.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/filter.py` & `aolab-bmi3d-0.9.6/riglib/filter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/fsm/fsm/fsm.py` & `aolab-bmi3d-0.9.6/riglib/fsm/fsm/fsm.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/gpio.py` & `aolab-bmi3d-0.9.6/riglib/gpio.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/hdfwriter/hdfwriter.py` & `aolab-bmi3d-0.9.6/riglib/hdfwriter/hdfwriter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/kinarmdata.py` & `aolab-bmi3d-0.9.6/riglib/kinarmdata.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/kinarmsocket.py` & `aolab-bmi3d-0.9.6/riglib/kinarmsocket.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/master8stimulation.py` & `aolab-bmi3d-0.9.6/riglib/master8stimulation.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/motiontracker.py` & `aolab-bmi3d-0.9.6/riglib/motiontracker.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/mp_calc.py` & `aolab-bmi3d-0.9.6/riglib/mp_calc.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/mp_proxy.py` & `aolab-bmi3d-0.9.6/riglib/mp_proxy.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/optitrack_client/optitrack.py` & `aolab-bmi3d-0.9.6/riglib/optitrack_client/optitrack.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/optitrack_client/optitrack_interface_sijia.py` & `aolab-bmi3d-0.9.6/riglib/optitrack_client/optitrack_interface_sijia.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/phidgets.py` & `aolab-bmi3d-0.9.6/riglib/phidgets.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/plants.py` & `aolab-bmi3d-0.9.6/riglib/plants.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/positioner/__init__.py` & `aolab-bmi3d-0.9.6/riglib/positioner/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/positioner/calib.py` & `aolab-bmi3d-0.9.6/riglib/positioner/calib.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/qwalor_laser.py` & `aolab-bmi3d-0.9.6/riglib/qwalor_laser.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/reward.py` & `aolab-bmi3d-0.9.6/riglib/reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/reward_crist.py` & `aolab-bmi3d-0.9.6/riglib/reward_crist.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/serial_dio.py` & `aolab-bmi3d-0.9.6/riglib/serial_dio.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/singleton.py` & `aolab-bmi3d-0.9.6/riglib/singleton.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/sink.py` & `aolab-bmi3d-0.9.6/riglib/sink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/source.py` & `aolab-bmi3d-0.9.6/riglib/source.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/environment.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/environment.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/ik.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/ik.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/models.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/primitives.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/primitives.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/render/fbo.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/render/fbo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/render/render.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/render/render.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/render/shader.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/render/shader.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/render/ssao.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/render/ssao.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/render/stereo.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/render/stereo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/textures.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/textures.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/utils.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/utils.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/window.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/window.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stereo_opengl/xfm.py` & `aolab-bmi3d-0.9.6/riglib/stereo_opengl/xfm.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/stimulus_pulse.py` & `aolab-bmi3d-0.9.6/riglib/stimulus_pulse.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/tablet_reward.py` & `aolab-bmi3d-0.9.6/riglib/tablet_reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/riglib/touch_data.py` & `aolab-bmi3d-0.9.6/riglib/touch_data.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/Link.py` & `aolab-bmi3d-0.9.6/robot/Link.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/Quaternion.py` & `aolab-bmi3d-0.9.6/robot/Quaternion.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/Robot.py` & `aolab-bmi3d-0.9.6/robot/Robot.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/SerialLink.py` & `aolab-bmi3d-0.9.6/robot/SerialLink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/dynamics.py` & `aolab-bmi3d-0.9.6/robot/dynamics.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/jacobian.py` & `aolab-bmi3d-0.9.6/robot/jacobian.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/kinematics.py` & `aolab-bmi3d-0.9.6/robot/kinematics.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/manipulability.py` & `aolab-bmi3d-0.9.6/robot/manipulability.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/parsedemo.py` & `aolab-bmi3d-0.9.6/robot/parsedemo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/plot.py` & `aolab-bmi3d-0.9.6/robot/plot.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/trajectory.py` & `aolab-bmi3d-0.9.6/robot/trajectory.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/transform.py` & `aolab-bmi3d-0.9.6/robot/transform.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/robot/utility.py` & `aolab-bmi3d-0.9.6/robot/utility.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/setup.py` & `aolab-bmi3d-0.9.6/setup.py`
...
### Comparing `aolab-bmi3d-0.9.5/tests/test_decoders.py` & `aolab-bmi3d-0.9.6/tests/test_decoders.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/tests/test_ecube.py` & `aolab-bmi3d-0.9.6/tests/test_ecube.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/tests/test_features.py` & `aolab-bmi3d-0.9.6/tests/test_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/tests/test_qwalor_laser.py` & `aolab-bmi3d-0.9.6/tests/test_qwalor_laser.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/tests/test_reward.py` & `aolab-bmi3d-0.9.6/tests/test_reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/tests/test_tasks.py` & `aolab-bmi3d-0.9.6/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/angle_utils.py` & `aolab-bmi3d-0.9.6/utils/angle_utils.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/drawbox.py` & `aolab-bmi3d-0.9.6/utils/drawbox.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/fixpaths.py` & `aolab-bmi3d-0.9.6/utils/fixpaths.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/make_autoalign.py` & `aolab-bmi3d-0.9.6/utils/make_autoalign.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/reassociate.py` & `aolab-bmi3d-0.9.6/utils/reassociate.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/ringbuffer.py` & `aolab-bmi3d-0.9.6/utils/ringbuffer.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.5/utils/util_fns.py` & `aolab-bmi3d-0.9.6/utils/util_fns.py`
