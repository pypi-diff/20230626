# Comparing `tmp/CodeToCAD-0.2.1687733068.tar.gz` & `tmp/CodeToCAD-0.2.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "CodeToCAD-0.2.1687733068.tar", last modified: Sun Jun 25 22:45:18 2023, max compression
+gzip compressed data, was "CodeToCAD-0.2.6.tar", last modified: Tue Mar 14 18:44:06 2023, max compression
```

## Comparing `CodeToCAD-0.2.1687733068.tar` & `CodeToCAD-0.2.6.tar`

### file list

```diff
@@ -1,19 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-25 22:45:18.672353 CodeToCAD-0.2.1687733068/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-25 22:45:18.668353 CodeToCAD-0.2.1687733068/CodeToCAD/
--rw-r--r--   0 runner    (1001) docker     (123)    58413 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/CodeToCAD/CodeToCADInterface.py
--rw-r--r--   0 runner    (1001) docker     (123)    24868 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/CodeToCAD/CodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)    36766 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/CodeToCAD/TestCodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)     3539 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/CodeToCAD/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    33016 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/CodeToCAD/utilities.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-25 22:45:18.672353 CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     7204 2023-06-25 22:45:18.000000 CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      325 2023-06-25 22:45:18.000000 CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-25 22:45:18.000000 CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-25 22:45:18.000000 CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)    32473 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       19 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     7204 2023-06-25 22:45:18.672353 CodeToCAD-0.2.1687733068/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     6662 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-25 22:45:18.672353 CodeToCAD-0.2.1687733068/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1079 2023-06-25 22:45:10.000000 CodeToCAD-0.2.1687733068/setup.py
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-25 22:45:18.000000 CodeToCAD-0.2.1687733068/version.txt
...
### Comparing `CodeToCAD-0.2.1687733068/CodeToCAD/CodeToCADInterface.py` & `CodeToCAD-0.2.6/CodeToCAD/CodeToCADInterface.py`
...
### Comparing `CodeToCAD-0.2.1687733068/CodeToCAD/TestCodeToCADProvider.py` & `CodeToCAD-0.2.6/CodeToCAD/TestCodeToCADProvider.py`
...
### Comparing `CodeToCAD-0.2.1687733068/CodeToCAD/__init__.py` & `CodeToCAD-0.2.6/CodeToCAD/__init__.py`
...
### Comparing `CodeToCAD-0.2.1687733068/CodeToCAD/utilities.py` & `CodeToCAD-0.2.6/CodeToCAD/utilities.py`
...
### Comparing `CodeToCAD-0.2.1687733068/CodeToCAD.egg-info/PKG-INFO` & `CodeToCAD-0.2.6/CodeToCAD.egg-info/PKG-INFO`
...
### Comparing `CodeToCAD-0.2.1687733068/LICENSE` & `CodeToCAD-0.2.6/LICENSE`

 * *Files identical despite different names*

### Comparing `CodeToCAD-0.2.1687733068/PKG-INFO` & `CodeToCAD-0.2.6/PKG-INFO`
...
### Comparing `CodeToCAD-0.2.1687733068/README.md` & `CodeToCAD-0.2.6/README.md`
