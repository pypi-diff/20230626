# Comparing `tmp/licensecheck-2023.1.3.tar.gz` & `tmp/licensecheck-2023.1.4.tar.gz`
...
## Comparing `licensecheck-2023.1.3.tar` & `licensecheck-2023.1.4.tar`
...
### Comparing `licensecheck-2023.1.3/LICENSE.md` & `licensecheck-2023.1.4/LICENSE.md`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/licensecheck/__init__.py` & `licensecheck-2023.1.4/licensecheck/__init__.py`
...
### Comparing `licensecheck-2023.1.3/licensecheck/formatter.py` & `licensecheck-2023.1.4/licensecheck/formatter.py`
...
### Comparing `licensecheck-2023.1.3/licensecheck/get_deps.py` & `licensecheck-2023.1.4/licensecheck/get_deps.py`
...
### Comparing `licensecheck-2023.1.3/licensecheck/license_matrix.py` & `licensecheck-2023.1.4/licensecheck/license_matrix.py`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/licensecheck/packageinfo.py` & `licensecheck-2023.1.4/licensecheck/packageinfo.py`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/licensecheck/pypi_licenses/osi_approved.txt` & `licensecheck-2023.1.4/licensecheck/pypi_licenses/osi_approved.txt`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/licensecheck/pypi_licenses/other.txt` & `licensecheck-2023.1.4/licensecheck/pypi_licenses/other.txt`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/licensecheck/types.py` & `licensecheck-2023.1.4/licensecheck/types.py`
...
### Comparing `licensecheck-2023.1.3/pyproject.toml` & `licensecheck-2023.1.4/pyproject.toml`
...
### Comparing `licensecheck-2023.1.3/README.md` & `licensecheck-2023.1.4/README.md`

 * *Files identical despite different names*

### Comparing `licensecheck-2023.1.3/setup.py` & `licensecheck-2023.1.4/setup.py`
...
### Comparing `licensecheck-2023.1.3/PKG-INFO` & `licensecheck-2023.1.4/PKG-INFO`
