# Comparing `tmp/madml-0.0.3.tar.gz` & `tmp/madml-0.0.4.tar.gz`
...
## Comparing `madml-0.0.3.tar` & `madml-0.0.4.tar`
...
### Comparing `madml-0.0.3/LICENSE` & `madml-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `madml-0.0.3/PKG-INFO` & `madml-0.0.4/PKG-INFO`
 ...
 * *File "/tmp/diffoscope_vx3o8agp_/tmptnz_3hgv_TarContainer/0/2", line 99, column 0: CDATA terminal not found*
...
### Comparing `madml-0.0.3/README.md` & `madml-0.0.4/README.md`

 * *Files identical despite different names*

### Comparing `madml-0.0.3/setup.py` & `madml-0.0.4/setup.py`
...
### Comparing `madml-0.0.3/src/madml.egg-info/PKG-INFO` & `madml-0.0.4/src/madml.egg-info/PKG-INFO`
 ...
 * *File "/tmp/diffoscope_vx3o8agp_/tmptnz_3hgv_TarContainer/0/9", line 99, column 0: CDATA terminal not found*
...
### Comparing `madml-0.0.3/tests/test_run.py` & `madml-0.0.4/tests/test_run.py`
