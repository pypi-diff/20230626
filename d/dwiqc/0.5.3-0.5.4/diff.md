# Comparing `tmp/dwiqc-0.5.3-py2.py3-none-any.whl.zip` & `tmp/dwiqc-0.5.4-py2.py3-none-any.whl.zip`
...
## Comparing `dwiqc-0.5.3.data/scripts/dwiQC.py` & `dwiqc-0.5.4.data/scripts/dwiQC.py`

 * *Files identical despite different names*

## Comparing `dwiqc-0.5.3.dist-info/LICENSE` & `dwiqc-0.5.4.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `dwiqc-0.5.3.dist-info/RECORD` & `dwiqc-0.5.4.dist-info/RECORD`
