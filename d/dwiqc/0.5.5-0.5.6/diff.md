# Comparing `tmp/dwiqc-0.5.5-py2.py3-none-any.whl.zip` & `tmp/dwiqc-0.5.6-py2.py3-none-any.whl.zip`
...
## Comparing `dwiqc-0.5.5.data/scripts/dwiQC.py` & `dwiqc-0.5.6.data/scripts/dwiQC.py`

 * *Files identical despite different names*

## Comparing `dwiqc-0.5.5.dist-info/LICENSE` & `dwiqc-0.5.6.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `dwiqc-0.5.5.dist-info/RECORD` & `dwiqc-0.5.6.dist-info/RECORD`
